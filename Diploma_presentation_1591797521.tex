...
В задаче стабилизации $L$ -- параметр настройки, условно он выбирается "пользователем"{}, а $L$ в экономическом МРС -- задается исходя из экономических требований к процессу.
