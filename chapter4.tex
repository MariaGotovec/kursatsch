\chapter{ОПТИМАЛЬНОЕ ПРОГРАММНОЕ РЕШЕНИЕ}\label{chap4}
В данной главе будут приведены программные решения задачи об оптимизации экономического роста страны-последователя, с помощью Direct Single Shooting и алгоритма МРС. Приводятся результаты численных экспериментов и их анализ.
...
\section{Оптимальное программное решение алгоритма МРС}
...
\centering
\includegraphics[width=0.75\linewidth]{1sT3V06B1P05K09XY13g01.png}
...
\centering
\includegraphics[width=0.75\linewidth]{mpc1.png}
...
\centering
\includegraphics[width=0.75\linewidth]{udss.png}
...
\centering
\includegraphics[width=0.75\linewidth]{umpc.png}
